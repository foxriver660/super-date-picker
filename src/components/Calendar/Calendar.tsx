  ...
  return (
    <div className="calendar">
      <div className="calendar__header">
        ...
        {state.mode === "days" && (
          <div className="calendar__header__title" aria-hidden onClick={() => functions.setMode("monthes")}>
            {state.monthesNames[state.selectedMonth.monthIndex].month} {state.selectedYear}
          </div>
        )}
        {state.mode === "monthes" && (
          <div className="calendar__header__title" aria-hidden onClick={() => functions.setMode("years")}>
            {state.selectedYear}
          </div>
        )}
        {state.mode === "years" && (
